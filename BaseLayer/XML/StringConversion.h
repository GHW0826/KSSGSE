#pragma once
#ifndef __STRINGCONVERSION__
#define __STRINGCONVERSION__
...
namespace StringConversion
{
	...
	inline std::wstring	ToString(const std::string p)  { return To<std::wstring>(p); }
	inline std::wstring	ToString(const std::wstring p) { return p; }
